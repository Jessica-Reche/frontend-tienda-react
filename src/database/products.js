...
export const deleteProduct = async(id, token) => {
  ...
  const ENDPOINT = `https://backend-tienda-7n96eutm5-jessica-reche.vercel.app/product/deleteProduct/${id}`;
...
export const addProduct = async(product, token) => {
  ...
  const ENDPOINT = `https://backend-tienda-7n96eutm5-jessica-reche.vercel.app/product/createProduct`;
...
export const updateProduct = async(id, productData,token) => {
  const data = Object.fromEntries(productData);
    ...
    const response = await fetch( `https://backend-tienda-7n96eutm5-jessica-reche.vercel.app/product/updateProduct/${id}`, requestOptions);
